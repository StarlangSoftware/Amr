...
public class TestAmrFrame {
    ...
    private static void outputDataSet(AmrCorpus corpus, AnnotatedCorpus corpus2, PrintWriter output, String path){
        int j = 0;
    ...
    private static void gbDataset() throws FileNotFoundException {
    ...
    private static void tourismDataset() throws FileNotFoundException {
        PrintWriter output = new PrintWriter(new File("output.html"));
    ...
    private static void framenetDataset() throws FileNotFoundException {
        PrintWriter output = new PrintWriter(new File("output.html"));
